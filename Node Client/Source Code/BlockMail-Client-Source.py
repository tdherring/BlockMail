...
SYNC_PORT = 41287  # Blockchain node sync port. DO NOT CHANGE.
BROADCAST_PORT = 41288  # Blockchain node broadcast port. DO NOT CHANGE.
...
class FrontendCommsServer:
    ...
    async def establishSocket(self, websocket, path):
        try:
            ...
            print("[WARNING] Error occurred in WebSocket connection to frontend client.")
        try:
